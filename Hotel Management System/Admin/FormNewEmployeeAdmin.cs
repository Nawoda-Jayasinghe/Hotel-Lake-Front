            ...
            else
            {
                ...
                if (reslult == DialogResult.Yes)
                {
                    try
                    {
                        ...
                        string sql = "CALL addNewEmp('" + lblStaffID.Text + "','" + txtFName.Text + "','" + txtFullName.Text + "','" + PosID + "','" + mtbNIC.Text + "','" + gender + "','" + mtbTP1.Text + "'," + tp2 + ",'" + rchtxtAddress.Text + "','" + lblPw.Text + "','" + email + "','" + Jdate + "')";
